...
public class SiparisController {
    ...
    public ResponseEntity<SiparisSchema> SiparisKaydet(@RequestBody(required = true) @Valid SiparisSchema siparisSchema, UrunSchema urunSchema) {
        try {
            SiparisSchema _sSchema = siparisRepository.save(new SiparisSchema(siparisSchema.getMasaNo(), siparisSchema.getUrun(urunSchema.getUrun(), urunSchema.getFiyat(), urunSchema.getIcindekiler()), siparisSchema.getEkstralar(), siparisSchema.getNot(), siparisSchema.getToplamFiyat(), siparisSchema.isSiparisAktifMi()));
    ...
    public ResponseEntity<SiparisSchema> düzenleme(@RequestBody(required = true) SiparisSchema siparisSchema, UrunSchema urunSchema) {
        siparisRepository.findById(siparisSchema.getId());
        siparisSchema.setMasaNo(siparisSchema.getMasaNo());
        siparisSchema.setUrun(siparisSchema.getUrun(urunSchema.getUrun(), urunSchema.getFiyat(), urunSchema.getIcindekiler()));
